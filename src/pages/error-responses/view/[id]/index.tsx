...
import { getErrorResponseById } from 'apiSdk/error-responses';
import { ErrorResponseInterface } from 'interfaces/error-response';

function ErrorResponseViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('error_response', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/error-responses/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Error Code" text={data?.error_code} />

                <FormListItem label="Error Message" text={data?.error_message} />

                <FormListItem
                  label="Occurred At"
                  text={data?.occurred_at ? format(parseISO(data?.occurred_at as unknown as string), 'dd-MM-yyyy') : ''}
                />
