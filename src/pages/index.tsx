...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`authrisation api `}</title>

        <meta
          name="description"
          content="Authrisation API: Unleashing the power of user identity management. With our endpoints, manage logins, sign ups, passwords and more. Offering jwt token authentication, profile management with varied HTTP methods and password management featuring basic auth, Passwordless, and Multi-factor Auth."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1618044619888-009e412ff12a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhdXRoZW50aWNhdGlvbnxlbnwwfHx8fDE2OTU1NzM1NDN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Authrisation API: Unleashing the power of user identity management. With our endpoints, manage logins, sign ups, passwords and more. Offering jwt token authentication, profile management with varied HTTP methods and password management featuring basic auth, Passwordless, and Multi-factor Auth.`}
            </Text>
            <Box
